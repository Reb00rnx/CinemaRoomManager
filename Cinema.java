...
//          int fullPrice = sos<=60? sos*10:(((getNumberOfSeats()/2)*getNumberOfRows()*10)+((sos-((getNumberOfSeats()/2)*getNumberOfRows()*10))*8));
        setIncome(fullPrice);
    }
    void showTheSeats() {
    ...
    void buyTicket(){
        ...
        do {
            ...
            int halfSeats = (int) getNumberOfSeats()*(getNumberOfRows() / 2);
//
